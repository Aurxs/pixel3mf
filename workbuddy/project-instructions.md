...
- Use Plan mode for creative generation, recognizable characters, or any task that may spend TokenHub credits.
...
- Use `tools/workbuddy_pixel3mf.py` for run initialization, TokenHub generation, source decisions, and conversion. Do not recreate the Python pipeline in shell commands.
...
- Do not use WorkBuddy ImageGen as an automatic fallback.
