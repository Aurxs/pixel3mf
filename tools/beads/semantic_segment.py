...
def run_segmentation_model(
    ...
    *,
    ...
    # Model cache is a runtime dependency, never a different skill or project checkout.
    model_dir = Path(os.environ.get("U2NET_HOME", str(Path.home() / ".u2net"))).expanduser()
