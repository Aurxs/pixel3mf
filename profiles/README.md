...
The snapshot also contains the pixel3mf-specific overrides documented in the project README. Keeping the flattened snapshot in the outer repository makes export deterministic and avoids a runtime dependency on Bambu Studio or edits inside `Lumina-Layers/`.
